...
const faqs: { id: string; q: string; a: ReactNode }[] = [
  {
    ...
    a: `Да, приложението „Твоята София" се финансира от Столична община и може да бъде използвано напълно безплатно.`,
  },
  {
    id: 'registration',
    q: 'Нужна ли е регистрация?',
    a: `Основните функционалности на мобилното приложение като новини, карта, качество на въздуха и транспорт са достъпни без регистрация. 
    Акаунт е необходим за:
    - Подаване на сигнали за проблеми в градската среда
    - Достъп до административния портал за управление е необходимо да сте одобрен от администратор на Столична община`,
  },
  {
    id: 'submit-signal',
    q: 'Как да подам сигнал за проблем?',
    a: `Към момента се поддържат само сигнали за сметосъбирането в район Триадица.
    В бъдеще планираме да разширим възможностите за подаване на сигнали и към други категории проблеми в градската среда.

    Отворете картата с контейнерите, изберете проблемния контейнер и подайте сигнал за него.`,
  },
  {
    id: 'track-signal',
    q: 'Мога ли да следя статуса на моя сигнал?',
    a: `Да. В раздел „Моите сигнали" виждате всички Ваши подадени сигнали и техния статус – нов, в процес или решен.
    При промяна на статуса ще получите известие в приложението.`,
  },
  {
    id: 'resolve-signal',
    q: 'Кой отговаря за разрешаването на проблемите след сигнал?',
