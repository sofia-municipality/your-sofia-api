      ...
      <div className="container mx-auto px-4 py-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 mb-12">
            <h3 className="text-2xl font-semibold text-gray-800 mb-6">Изтеглете приложението</h3>
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-xs">Изтеглете от</div>
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-xs">НАМЕРЕТЕ В</div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-12">
            <div className="bg-purple-50 p-6 rounded-xl">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">Градски новини</h4>
              <p className="text-gray-600">Бъдете в крак със събитията и обявленията</p>
            </div>
            <div className="bg-green-50 p-6 rounded-xl">
              <div className="text-4xl mb-3">🗺️</div>
              <h4 className="font-semibold text-gray-900 mb-2">Интерактивна карта</h4>
            ...
            <div className="bg-blue-50 p-6 rounded-xl">
              <div className="text-4xl mb-3">📱</div>
              <h4 className="font-semibold text-gray-900 mb-2">Докладвайте проблеми</h4>
              <p className="text-gray-600">
