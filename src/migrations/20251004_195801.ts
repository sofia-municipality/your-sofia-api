...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum__posts_v_published_locale" AS ENUM('bg', 'en');
  CREATE TYPE "public"."enum_push_tokens_device" AS ENUM('ios', 'android');
  ...
  CREATE TABLE IF NOT EXISTS "news" (
  	...
  	"topic" "enum_news_topic" DEFAULT 'city-events' NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE IF NOT EXISTS "push_tokens" (
  	...
  	"device" "enum_push_tokens_device" NOT NULL,
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS "push_tokens_token_idx" ON "push_tokens" USING btree ("token");
  CREATE INDEX IF NOT EXISTS "push_tokens_updated_at_idx" ON "push_tokens" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "push_tokens_created_at_idx" ON "push_tokens" USING btree ("created_at");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_push_tokens_id_idx" ON "payload_locked_documents_rels" USING btree ("push_tokens_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_push_tokens_device";
